...
class _BirthdayWidgetState extends BaseState<BirthdayWidget> {
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              SizedBox(height: _pickedDate == null ? 5.0 : 20.0),
              _pickedDate == null
                  ? const SizedBox()
  ...
  String _getMonth() => DateFormat('MMMM').format(_pickedDate!);

  String _getDay() => DateFormat('dd').format(_pickedDate!);

  String _getYear() => DateFormat('yyyy').format(_pickedDate!);

  void _onAuthorize() {
    final date = DateFormat('yyyy-MM-dd').format(_pickedDate!);
